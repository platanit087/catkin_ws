...
EnvironmentClient::EnvironmentClient(ros::NodeHandle * n) {
...
void EnvironmentClient::init(ros::NodeHandle * n) {
	client = new ros::ServiceClient(
			n->serviceClient<common::Environment>("environment_service"));
}

std::vector<geometry_msgs::Polygon> EnvironmentClient::call() {
...
biorobotics::Polygon * EnvironmentClient::convertGeometryMsgToPolygons(
